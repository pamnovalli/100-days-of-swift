...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if allWords.isEmpty {
            let defaultWord = ["silkworm"]
            allWords = defaultWord
            defaults.set(defaultWord, forKey: "word")
        }
    ...
    @objc func startGame(){
        ...
        title = word
        usedWords = defaults.stringArray(forKey: "answer") ?? [String]()
    }
    
    @objc func reloadGame() {
        let wordSelected = allWords.randomElement()
        defaults.set(wordSelected, forKey: "word")
        title = wordSelected
        ...
        if isPossible(word: lowerAnswer) {
            if isOriginal(word: lowerAnswer) {
                if isReal(word: lowerAnswer) {
                    ...
                    defaults.set(usedWords, forKey: "answer")
